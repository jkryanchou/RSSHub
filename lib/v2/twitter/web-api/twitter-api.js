...
function gatherLegacyFromData(entries, filterNested = undefined) {
    const tweets = [];
...
const getUserTweetsAndRepliesByID = async (id, params = {}) => gatherLegacyFromData(await timelineTweetsAndReplies(id, params), ['profile-conversation-']);
